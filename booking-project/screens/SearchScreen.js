...
const SearchScreen = () => {
    ...
    //Data Extracted From Api for Property Details
    const data = [
        {
          id: "0",
          place: "Bangalore",
  ...
  return (
    ...
    <SafeAreaView style={{marginTop:25}}>
      <View style={{padding:10, margin:10, flexDirection:'row',alignItems:'center', justifyContent:'space-between', borderColor:"#FFC72C",borderWidth:4,borderRadius:10 }}>
